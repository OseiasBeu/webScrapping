...
def encontraArquivosEmPastaRecursivamente(pasta, extensao):
    ...
    for pastaAtual, subPastas, arquivos  in os.walk(caminhoAbsoluto):
        arquivosTxt.extend([os.path.join(pastaAtual,arquivo) for arquivo in arquivos if arquivo.endswith('.xlsx')])
    return arquivosTxt

print(encontraArquivosEmPastaRecursivamente(oldAddres, '.xlsx'))
