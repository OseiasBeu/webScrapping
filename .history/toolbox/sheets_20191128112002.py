...
def insertPlanMiddleware(rows):
    ...
    batch_update_spreadsheet_request_body = {
       ...
       'requests':[1,2,3,4],  # TODO: Update placeholder value.

       # TODO: Add desired entries to the request body.
    }
    service.spreadsheets().batchUpdate(spreadsheetId=SAMPLE_SPREADSHEET_ID, body = batch_update_spreadsheet_request_body).execute()
    print("item inserido")    
