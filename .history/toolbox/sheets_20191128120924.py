...
# How the input data should be interpreted.
    for row in rows:   
        # value_input_option = 'INPUT_VALUE_OPTION_UNSPECIFIED'  # TODO: Update placeholder value.
        value_range_body = {1,2,3,4}
        
        request = service.spreadsheets().values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range=SAMPLE_RANGE_NAME, body=value_range_body)
